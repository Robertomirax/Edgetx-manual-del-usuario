...
* [Manual para radios con pantalla color](edgetx-user-manual/user-manual-for-color-screen-radios/README.md)
  ...
  * [Configuración del modelo](edgetx-user-manual/user-manual-for-color-screen-radios/model-settings/README.md)
    ...
    * [Telemetry (telemetría)](edgetx-user-manual/user-manual-for-color-screen-radios/model-settings/telemetry/README.md)
      * [Sensor Configuration Options (Opciones de configuración de los sensores)](edgetx-user-manual/user-manual-for-color-screen-radios/model-settings/telemetry/sensor-configuration-options.md)
      * [Common Telemetry Sensors (Sensores comunes de telemetría)](edgetx-user-manual/user-manual-for-color-screen-radios/model-settings/telemetry/common-telemetry-sensors.md)
  * [Configuración de la radio](edgetx-user-manual/user-manual-for-color-screen-radios/radio-settings/README.md)
    * [Tools (Herramientas)](edgetx-user-manual/user-manual-for-color-screen-radios/radio-settings/tools.md)
    * [SD Card (tarjeta SD)](edgetx-user-manual/user-manual-for-color-screen-radios/radio-settings/sd-card.md)
    * [Radio Setup (Ajustes de la radio)](edgetx-user-manual/user-manual-for-color-screen-radios/radio-settings/radio-setup/README.md)
      * [Additional Radio settings (Ajustes adicionales de la radio)](edgetx-user-manual/user-manual-for-color-screen-radios/radio-settings/radio-setup/additional-radio-settings.md)
    * [Themes (Temas)](edgetx-user-manual/user-manual-for-color-screen-radios/radio-settings/themes.md)
    * [Global Functions (Funciones globales)](edgetx-user-manual/user-manual-for-color-screen-radios/radio-settings/global-functions.md)
