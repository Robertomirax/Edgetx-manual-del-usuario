...
* **Label Model** - Al seleccionar esta opción, se mostrarán todas las etiquetas y podrán ser asignadas a este modelo. Ver [Model Labels](select-model.md#model-labels) is below.&#x20;
